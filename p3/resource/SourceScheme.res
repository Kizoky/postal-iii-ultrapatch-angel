...
Scheme
{
	...
	Colors
	{
		...
		"DarkGrayTransparent" "16 16 16 255"
		"Black"				"0 0 0 255"
		
		"Beige"				"220 215 190 255"
	...
	BaseSettings
	{
		...
		Border.Selection				"255 0 0 196"			// the additional border color for displaying the default/selected button
		...
		CheckButton.SelectedTextColor		"Red"
		CheckButton.BgColor			"TransparentBlack"
		CheckButton.Border1  			"Border.Bright"//"Border.Dark" 		// the left checkbutton border
		CheckButton.Border2  			"Border.Bright"		// the right checkbutton border
		CheckButton.Check			"Red"	// color of the check itself
		...
		Frame.BgColor					"DarkGrayTransparent"	[$WIN32]
		Frame.BgColor					"16 16 16 192"		[$X360]
		Frame.OutOfFocusBgColor			"Black"	[$WIN32]
		...
		Menu.BgColor					"DarkGrayTransparent"
		...
		WizardSubPanel.BgColor		"TransparentBlack"

		// scheme-specific colors
		MainMenu.TextColor			"White"				[$WIN32]
		MainMenu.TextColor			"200 200 200 255"	[$X360]
		MainMenu.ArmedTextColor		"Red"	[$WIN32]
		MainMenu.ArmedTextColor		"White"				[$X360]
		MainMenu.DepressedTextColor	"192 186 80 255"
		MainMenu.MenuItemHeight		"38"				[$WIN32]
		...
		NewGame.SelectionColor		"Red"			[$WIN32]
